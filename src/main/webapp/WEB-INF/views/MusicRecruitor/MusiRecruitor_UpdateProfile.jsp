...
<div class="container">
	...
	<form:form commandName="musician" action="musicrecruitor-updatedetails.htm" method="post" id="form1" onsubmit="return validate();">
		<fieldset>
			<br>
			<div class="row">
				<div class="col-sm-12 col-md-10  col-md-offset-1 ">
					...
					<label for="genre">Genre*: </label>
						<form:input path="genre" class="form-control"
							...
							id="genre" type="text" readonly="true" />
					...
					<label for="achievements">Achievements: </label>
						<form:input path="achievements" class="form-control"
							...
							id="achievements" type="text" readonly="true" />
					...
					<label for="mobileNumber">Contact Number*: </label>
						<form:input path="mobileNumber" class="form-control"
							...
							id="mobileNumber" type="text" readonly="true" />
